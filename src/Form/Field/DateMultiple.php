...
class DateMultiple extends Text
{
    protected static $css = [
        ...
        'vendor/laravel-admin/flatpickr/dist/themes/light.min.css',

    ];

    protected static $js = [
        'vendor/laravel-admin/flatpickr/dist/flatpickr.min.js',
        'vendor/laravel-admin/flatpickr/dist/shortcut-buttons-flatpickr.min.js',
