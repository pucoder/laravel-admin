@if(!$holdAll)
<div class="btn-group table-select-all-btn mr-2 d-none">
    <a class="btn btn-sm btn-default"><span class="selected" data-tpl="{{ admin_trans('admin.table_items_selected') }}"></span></a>
